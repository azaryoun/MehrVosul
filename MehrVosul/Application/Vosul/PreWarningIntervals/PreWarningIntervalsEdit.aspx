<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="PreWarningIntervalsEdit.aspx.vb" Inherits="MehrVosul.PreWarningIntervalsEdit" %>
                        ...
                        <div class="panel-body" style="max-height: 200px;overflow-y: scroll;">
                          <label> <input type="checkbox" value="" id="chkSelectAll" onclick="return chkSelectAll_Click();"/> انتخاب/عدم انتخاب همه </label> 
                                         ...
                                         <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtMinimumAmount" runat="server" cssclass="form-control" MaxLength="50" placeholder="0"></asp:TextBox>
