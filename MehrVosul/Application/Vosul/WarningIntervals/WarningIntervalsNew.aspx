...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="form-group">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="max-height: 200px;">
                                        ...
                                        <div class='checkbox'>
                                            <label>
                                                <input type='checkbox' id="chkbxIssueIntroductionLetter" runat="server" />
                                                دعوت نامه
                                        ...
                                        <div class='checkbox'>
                                            <label>
                                                <input type='checkbox' id="chkbxIssueNotice" runat="server" />
                                                اخطاریه
                                        ...
                                        <div class='checkbox'>
                                            <label>
                                                <input type='checkbox' id="chkbxIssueManifest" runat="server" />
                                                اظهارنامه
                            ...
                            <div class="form-group">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body" style="max-height: 200px;">
                                        ...
                                        <div class='checkbox'>
                                            <label>
                                                <input type='checkbox' id="chkbxToBorrower" runat="server" />
                                                ارسال به وام گیرنده
                                        ...
                                        <div class='checkbox'>
                                            <label>
                                                <input type='checkbox' id="chkbxToSponsor" runat="server" />
                                                ارسال به ضامن(ها)
    ...
    <label>
        <input type="checkbox" value="" id="chkBranchSelectAll" style="visibility: hidden" /></label>
