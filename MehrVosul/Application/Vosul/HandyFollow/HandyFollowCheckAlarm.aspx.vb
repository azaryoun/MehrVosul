Public Class HandyFollowCheckAlarm
    ...
    Private Sub GetList()
        ...
        Dim dtblHandyFolow As BusinessObject.dstAlarm.spr_HandyFollowCheckAlarm_SelectDataTable = Nothing
            ...
            If drwUserLogin.IsDataUserAdmin = True Then
                ...
                If dtblHandyFolow.Rows.Count > 0 Then
                    ...
                    For Each drwHandyFollow As BusinessObject.dstAlarm.spr_HandyFollowCheckAlarm_SelectRow In dtblHandyFolow
                        ...
                        TbCell = New HtmlTableCell
                        TbCell.InnerHtml = drwHandyFollow.CheckNO
                        TbCell.NoWrap = True
                        TbCell.Align = "center"
                        TbRow.Cells.Add(TbCell)
                        ...
                        TbCell = New HtmlTableCell
                        TbCell.InnerHtml = mdlGeneral.GetPersianDate(drwHandyFollow.CheckDate)
                        TbCell.NoWrap = True
                        TbCell.Align = "center"
                        TbRow.Cells.Add(TbCell)
