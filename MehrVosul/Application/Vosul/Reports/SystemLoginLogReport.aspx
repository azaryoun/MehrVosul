<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="SystemLoginLogReport.aspx.vb" Inherits="MehrVosul.SystemLoginLogReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        //    hdnCHKAll.value = chkBranchSelectAll.checked;
