<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="DraftText.aspx.vb" Inherits="MehrVosul.DraftText" EnableEventValidation="false"  %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function btnAddColumns(colHref) {
            ...
            switch (colHref) {
                case 1:
                    option.text = "(جنسیت وام گیرنده)";
                    break;
                case 2:
                    option.text = "(نام وام گیرنده)";
                    break;
                case 3:
                ...
                case 6:
                    ...
                    break;
                case 9:
                    option.text = "(جنسیت ضامن)";
                    break;
                case 7:
                    option.text = "(نام ضامن)";
                    break;
                case 8:
                    option.text = "(نام خانوادگی ضمان)";
                    break;
                            ...
                            <div  class="row">
                                <div class="col-md-12">
                                          ...
                                          -
                                           ...
                                           -
                                              <a href='#' onclick='return btnAddColumns(9);' >جنسیت(ضامن)</a>
                                            -
                                            <a href='#'  onclick='return btnAddColumns(7);' >نام(ضامن)</a>
                                           -
                                            <a  href='#'onclick='return btnAddColumns(8);' >نام خانوادگی(ضامن)</a>
                                        </div>
