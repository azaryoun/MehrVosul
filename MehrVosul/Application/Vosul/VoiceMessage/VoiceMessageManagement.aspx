<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="VoiceMessageManagement.aspx.vb" Inherits="MehrVosul.VoiceMessageManagement" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetPageRecords_CallBack(result) {
            ...
            for (k = 1; k < arrL.length; k++) {
                ...
                strHtml += "<td style=\"text-align:center\">" + "<a href='#' onclick='btnListen_Click(" + PKey + ")'>" + "<img alt='پخش' title='پخش' src='../../../../Images/System/audio.png' />" + "</a>" + "</td>";
                strHtml += "</tr>";
        ...
        function DeleteOperation_Validate_CallBack(result) {
            if (result != "") {
                alert("فرایند حذف با شکست مواجه شده است: " + result)
            }
        ...
        function btnChangePass_ClientClick(Pkey) {
            var hdnAction_Name = "<%=hdnAction.ClientID%>";
            var hdnAction = document.getElementById(hdnAction_Name);
