<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="FileManagement.aspx.vb" Inherits="MehrVosul.FileManagement" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetPageRecords_CallBack(result) {
            ...
            for (k = 1; k < arrL.length; k++) {
                ...
                strHtml += "<td><a href='#' onclick='btnNotification_ClientClick(" + PKey.toString() + ")'>تسهیلات</a>" + "</td>";
