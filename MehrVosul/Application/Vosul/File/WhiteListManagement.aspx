<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="WhiteListManagement.aspx.vb" Inherits="MehrVosul.WhiteListManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        var hdnLoanID_Name = "<%=hdnLoanID.ClientID%>";
        var hdnLoanID = document.getElementById(hdnLoanID_Name);
           
            PageMethods.GetPageCount(this.PageFilter,hdnLoanID.value, GetPageCount_CallBack);
            return true;
        }
        ...
        function GetPageCount_CallBack(result) {
            ...
            PageMethods.GetPageRecords(this.PageNo, this.PageFilter,hdnLoanID.value, GetPageRecords_CallBack);
        ...
        function GetPageRecords_CallBack(result) {
            ...
            for (k = 1; k < arrL.length; k++) {
                ...
                strHtml += "<td>" + strEditCell +"</td>";

                var i;
                for (i = 4; i < arrV.length-1; i++) {
...
<div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tblMResult">
                                    <thead>
                                        <tr>
                                        <th><input type="checkbox" value="" id="chkSelectAll" onclick="return chkSelectAll_Click();" title="Selects/Deselects all rows" /></th>
                                            <th>#</th>
                                            <th>تاریخ</th>
    ...
    <input id="hdnLoanID" type="hidden"  runat="server"/>
