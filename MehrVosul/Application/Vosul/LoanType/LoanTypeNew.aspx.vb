    ...
    Private Sub Bootstrap_Panel1_Panel_Save_Click(sender As Object, e As System.EventArgs) Handles Bootstrap_Panel1.Panel_Save_Click
        ...
        Try
            ...
            If txtSection.Text.Trim = "" Then
                qryLoanType.spr_LoanType_Insert(strLoanTypeCode, strLoanTypeName, drwUserLogin.ID, Nothing)
            Else
                qryLoanType.spr_LoanType_Insert(strLoanTypeCode, strLoanTypeName, drwUserLogin.ID, txtSection.Text.Trim)
            End If


        Catch ex As Exception
            Response.Redirect("LoanTypeManagement.aspx?Save=NO")
            Return
        End Try
