<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="NotificationTarrifNew.aspx.vb" Inherits="MehrVosul.NotificationTarrifNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function SaveOperation_Validate() {
            ...
            if (cmbNotification.options(cmbNotification.selectedIndex).value == 0) {
