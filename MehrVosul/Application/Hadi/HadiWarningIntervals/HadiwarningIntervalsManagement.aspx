<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="HadiwarningIntervalsManagement.aspx.vb" Inherits="MehrVosul.HadiwarningIntervalsManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
            ...
            for (k = 1; k < arrL.length; k++) {
                ...
                for (i = 4; i < arrV.length; i++) {
                    ...
                    if (i == 4) {
                        ...
                        strHtml += "<td nowrap='true'>" + arrV[i] + "</td>";
                    }
                    else {
        ...
        function btnDrafts_ClientClick(Pkey) {
            var hdnAction_Name = "<%=hdnAction.ClientID%>";
            var hdnAction = document.getElementById(hdnAction_Name);
         ...
         function btnExceptions_ClientClick(Pkey) {
            var hdnAction_Name = "<%=hdnAction.ClientID%>";
            var hdnAction = document.getElementById(hdnAction_Name);
            hdnAction.value = "X;" + Pkey;
            window.document.forms[0].submit();
            return false;
        }
  </script>
