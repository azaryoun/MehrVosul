<%@ Page Title=""  Async="true" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="HadiVoiceMessageDraftText.aspx.vb" Inherits="MehrVosul.HadiVoiceMessageDraftText" EnableEventValidation="false"  %>
        ...
        function btnAddColumns(colHref) {
            ...
            switch (colHref) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    option.text = "(تعداد روز دریافت وام)";
                    break;   
                        ...
                        <div class="panel-body">
                            <div  class="row">
                                <div class="col-md-12">
                                          ...
                                          -
                                            <a href='#' onclick='return btnAddColumns(2);' >تعداد روز دریافت وام</a>
