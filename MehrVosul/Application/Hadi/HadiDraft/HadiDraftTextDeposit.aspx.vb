Public Class HadiDraftTextDeposit
            ...
            For Each drwDraft As BusinessObject.dstHadiDraft.spr_HadiDraftText_SelectRow In dtblDraft
                ...
                If drwDraft.IsDynamic Then
                    Select Case drwDraft.DraftText
                        Case "1"
                            lstItem.Text = "(جنسیت صاحب سپرده)"
                            strSampleMessage &= " " & "آقای"
                        Case "2"
                            lstItem.Text = "(نام صاحب سپرده)"
                            strSampleMessage &= " " & "حسین"
                        Case "3"
                            lstItem.Text = "(نام خانوادگی صاحب سپرده)"
                        ...
                        Case "5"
                            ...
                            strSampleMessage &= " " & "23"
                        Case "6"
                            lstItem.Text = "(شعبه افتتاح سپرده)"
                            strSampleMessage &= " " & "میدان ونک"
                        Case "7"
                            lstItem.Text = "(نوع سپرده)"
                            strSampleMessage &= " " & "سپرده قرض الحسنه جاري"
                    End Select
