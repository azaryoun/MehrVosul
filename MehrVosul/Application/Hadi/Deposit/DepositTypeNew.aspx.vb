Public Class DepositTypeNew
    ...
    Private Sub Bootstrap_Panel1_Panel_Save_Click(sender As Object, e As System.EventArgs) Handles Bootstrap_Panel1.Panel_Save_Click
        ...
        Try
            ...
            qryDeposit.spr_DepositType_Insert(strDepositCode, strDepositName, drwUserLogin.ID)



        Catch ex As Exception
            Response.Redirect("DepositTypeManagement.aspx?Save=NO")
            Return
        End Try

        Response.Redirect("DepositTypeManagement.aspx?Save=OK")
