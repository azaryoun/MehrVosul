<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="NoticeEdit.aspx.vb" Inherits="MehrVosul.NoticeEdit" %>
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:LinkButton ID="lbtnNoticeFile" Visible="false" runat="server" CssClass="form-control">دانلود</asp:LinkButton>
