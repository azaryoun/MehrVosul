<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="AccessgroupManagement.aspx.vb" Inherits="MehrVosul.AccessgroupManagement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function GetPageRecords_CallBack(result) {
            ...
            var spnTableFooyerText = document.getElementById("spnTableFooyerText");
            spnTableFooyerText.innerHTML = "نمایش ردیف های " + intFrom.toString() + " تا " + intTo.toString() + " از " + this.RecordCount.toString() + " رکورد"
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tblMResult">
                                    <thead>
                                        <tr>
                                        <th title="انتخاب/عدم انتخاب همه رکوردهای این صفحه" onclick="return chkSelectAll_Click();">  <input type="checkbox" value="" id="chkSelectAll" onclick="return chkSelectAll_Click();">  </th>
                                            <th>#</th>
                                            <th>عنوان</th>
                                        </tr>
                                    </thead>
