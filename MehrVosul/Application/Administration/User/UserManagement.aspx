<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/SmartIntergace_Master.Master" CodeBehind="UserManagement.aspx.vb" Inherits="MehrVosul.UserManagement" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GetPageRecords_CallBack(result) {
            ...
            for (k = 1; k < arrL.length; k++) {
                ...
                strHtml += "<td><a href='#' onclick='btnChangePass_ClientClick(" + PKey.toString() + ")'>تغییر کلمه عبور</a>" + "</td>";
                strHtml += "</tr>";
