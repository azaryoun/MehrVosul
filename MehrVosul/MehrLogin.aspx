<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MehrLogin.aspx.vb" Inherits="MehrVosul.MehrLogin" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>به نرم افزار جامع وصول مطالبات بانک قرض الحسنه مهر ایران(وصال) خوش آمدید</title>
				...
				<div >
					<div align="center">
					    <asp:Image ID="Image1" runat="server"  style="width:100%"
                            ImageUrl="~/Images/System/MehrIranHeader.jpg" />
					</div>
					<div class="panel-body">
                                        ...
                                        <table>
                                          ...
                                          <th style="width:20px;"></th>
                                            <th>
                                               ...
                                               <label style="font-size: small">نام کاربری</label></div></th>  
                                            <th style="width:20px;"></th>
                                               <th>
			              	...
			              	<div class="form-group" style="display:none" id="divMessage" runat="server">
                                    ...
                                    نام کاربری یا رمز عبور نا معتبر است.
                                     ...
                                     <div class="form-group" style="display:none" id="divMessage1" runat="server"> <div class="alert alert-danger" role="alert">
                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                    <span class="sr-only">Error:</span>
                                    شعبه مطابقت ندارد.
                                    </div></div>
