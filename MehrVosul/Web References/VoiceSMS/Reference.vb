...
Namespace VoiceSMS
    ...
    Partial Public Class RahyabVoiceSend
        ...
        Private Refund_WarantyCreditOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event Refund_WarantyCreditCompleted As Refund_WarantyCreditCompletedEventHandler
        ...
        Public Function StatusVoiceSMS(ByVal strUsername As String, ByVal strPassword As String, ByVal intVoiceSMSID As Integer, ByVal intPageNo As Integer, ByRef strMessage As String) As String
            Dim results() As Object = Me.Invoke("StatusVoiceSMS", New Object() {strUsername, strPassword, intVoiceSMSID, intPageNo, strMessage})
            strMessage = CType(results(1),String)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub StatusVoiceSMSAsync(ByVal strUsername As String, ByVal strPassword As String, ByVal intVoiceSMSID As Integer, ByVal intPageNo As Integer, ByVal strMessage As String)
            Me.StatusVoiceSMSAsync(strUsername, strPassword, intVoiceSMSID, intPageNo, strMessage, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub StatusVoiceSMSAsync(ByVal strUsername As String, ByVal strPassword As String, ByVal intVoiceSMSID As Integer, ByVal intPageNo As Integer, ByVal strMessage As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("StatusVoiceSMS", New Object() {strUsername, strPassword, intVoiceSMSID, intPageNo, strMessage}, Me.StatusVoiceSMSOperationCompleted, userState)
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Refund_WarantyCredit", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function Refund_WarantyCredit(ByVal strUsername As String, ByVal strPassword As String, ByVal intVoiceSMSID As Integer, ByRef strMessage As String) As Integer()
            Dim results() As Object = Me.Invoke("Refund_WarantyCredit", New Object() {strUsername, strPassword, intVoiceSMSID, strMessage})
            strMessage = CType(results(1),String)
            Return CType(results(0),Integer())
        End Function
        
        '''<remarks/>
        Public Overloads Sub Refund_WarantyCreditAsync(ByVal strUsername As String, ByVal strPassword As String, ByVal intVoiceSMSID As Integer, ByVal strMessage As String)
            Me.Refund_WarantyCreditAsync(strUsername, strPassword, intVoiceSMSID, strMessage, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub Refund_WarantyCreditAsync(ByVal strUsername As String, ByVal strPassword As String, ByVal intVoiceSMSID As Integer, ByVal strMessage As String, ByVal userState As Object)
            If (Me.Refund_WarantyCreditOperationCompleted Is Nothing) Then
                Me.Refund_WarantyCreditOperationCompleted = AddressOf Me.OnRefund_WarantyCreditOperationCompleted
            End If
            Me.InvokeAsync("Refund_WarantyCredit", New Object() {strUsername, strPassword, intVoiceSMSID, strMessage}, Me.Refund_WarantyCreditOperationCompleted, userState)
        End Sub
        
        Private Sub OnRefund_WarantyCreditOperationCompleted(ByVal arg As Object)
            If (Not (Me.Refund_WarantyCreditCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent Refund_WarantyCreditCompleted(Me, New Refund_WarantyCreditCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0")>  _
    Public Delegate Sub Refund_WarantyCreditCompletedEventHandler(ByVal sender As Object, ByVal e As Refund_WarantyCreditCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.6.1055.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class Refund_WarantyCreditCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
